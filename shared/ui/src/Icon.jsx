/**
 * Tek kaynaklı SVG ikon seti. Çizimler Lucide'in (ISC) yollarından; lisans notu
 * hotel/frontend/THIRD_PARTY_LICENSES.md'de. Tamamı 24x24, currentColor,
 * 1.75 çizgi — karışık kalınlık ya da dolgu yok.
 *
 * Emoji ikon olarak kullanılmaz: işletim sistemine göre farklı çiziliyor, renk
 * alamıyor ve ekran okuyucu adını yüksek sesle okuyor.
 */
const PATHS = {
  dashboard: (
    <>
  ...
  eyeOff: (
    <>
      ...
      <path d="M6.61 6.61A13.53 13.53 0 0 0 2 12s3 7 10 7a9.74 9.74 0 0 0 5.39-1.61M2 2l20 20" />
  ...
  alertTriangle: <path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3M12 9v4M12 17h.01" />,
  alertCircle: (
    <>
      <circle cx="12" cy="12" r="10" />
 ...
 *   `title` verilirse ikon anlam taşıyan bir görsel olur (role="img");
 *   verilmezse dekoratif sayılıp ekran okuyucudan gizlenir.
 */
